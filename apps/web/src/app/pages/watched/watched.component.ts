...
@Component({
    ...
    <div class="page">
      ...
      @if (loading) {
        ...
        <div class="card empty-state">
          ...
          <p class="empty-text">Busque filmes e clique em "Assistido" para registrá-los aqui.</p>
        </div>
      } @else {
        <div class="card grid-card">
          <dx-data-grid [dataSource]="rows" [showBorders]="false" [columnAutoWidth]="true" keyExpr="id" [rowAlternationEnabled]="true" [hoverStateEnabled]="true">
            ...
            <dxi-column dataField="createdAt" caption="Marcado em" dataType="datetime" [width]="180"></dxi-column>
          </dx-data-grid>
        </div>
      }
  ...
  styles: [`
    ...
    .count-badge { background: #f0fff4; color: #276749; font-size: 0.8rem; font-weight: 600; padding: 0.3rem 0.85rem; border-radius: 20px; align-self: center; }
